<template>
	<button aria-label="Help button" class="p-1 mr-2 rounded-md focus-visible:ring-2 focus-visible:ring-primary hover:bg-black/5 dark:hover:bg-white/10" @click="openPanel()">
